	    ...
	    <div class="span12">
	      <div class="widget">
			...
			<div class="widget-content">
			  <ol class="faq-list">
				<li>
				  <h4>What is Recruit? How does the system work?</h4>
				  ...
				  <p>Recruit is a job seacrh website that automates the screening and shortlisting processes of recruitment. 
				...
				<li>
				  <h4>Who is behind Recruit?</h4>
				  <p> Recruit is a privately held company with global ambitions and consists of a well seasoned
				  management team and advisors. Kwabena Aboagye Dougan founded this company.</p>	
				</li>
				<li>
				  <h4> Is Recruit a recruitment firm?</h4>
				  <p> No. Recruit is NOT a recruitment agency. We do not do candidate interviewing but automate short-listing. 
