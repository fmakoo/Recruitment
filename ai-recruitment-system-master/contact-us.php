	...
	<div class="row">
	  ...
	  <div class="span3">
		<div class="contact-section-text">
		  ...
		  <p class="contact-info-text">Direct Dial: 254-91-635-893</p>
		  <p class="contact-info-text">Toll-Free: 254-00-901-901</p>
		  <p class="contact-info-text">Fax: 254-00-901-901</p><br/>
		  <p class="contact-info-text"><a href="mailto:contact@Recruit.com">contact@Recruit.com</a></p>
		</div>
	  </div>
	  <div class="span3">
		<div class="contact-section-text">
		  <p class="contact-info-header-text">SWING BY</p>
		  <p class="contact-info-text">Recruit</p>
		  <p class="contact-info-text">Kenyatta Street,</p>
		  <p class="contact-info-text">Nairobi, Kenya</p>
		</div>
	  </div>
	</div>
  </div>
